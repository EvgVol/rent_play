    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=datetime.date(2023, 3, 31), help_text='Укажите дату начала аренды', verbose_name='Начало аренды')),
                ('end_date', models.DateField(default=datetime.date(2023, 4, 1), help_text='Укажите дату окончание аренды', verbose_name='Конец аренды')),
