    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_date', models.DateField(default=datetime.date(2023, 4, 24), help_text='Укажите дату начала аренды', verbose_name='Начало аренды')),
                ('end_date', models.DateField(default=datetime.date(2023, 4, 25), help_text='Укажите дату окончание аренды', verbose_name='Конец аренды')),
