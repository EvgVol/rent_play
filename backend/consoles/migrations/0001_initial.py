...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('price', models.PositiveSmallIntegerField(default=500, validators=[django.core.validators.MinValueValidator(500, message='К сожалению вы указали меньше пороговой суммы 500 рублей')], verbose_name='Стоимость аренды')),
            ],
            options={
